...
class yogtark:
    ...
    def train(self, epoch):
        ...
        x = []
        y = []
        # To separate X and Y that is feature set and label from a csv following code is written
    ...
    def save(self):
        ...
        tfjs.converters.save_keras_model(self.model, "../model_implementation/output/yg-tfjsmodel")
